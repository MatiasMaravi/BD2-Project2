...
import math
import numpy as np
from preprocesar import preprocesamiento
from tf_idf import tf_dic, idf_dic, tf, df, norma
class InvertIndex:
    def __init__(self, index_file) -> None:
        self.index_file = os.path.join("doc",index_file) #Para guardar el archivo en la carpeta data
        self.index = {}
        self.idf = {}
        self.length = {}
    ...
    def building(self, collection_text) -> None:
        ...
        def process_file(file_name):
            with open( os.path.join('doc',file_name), 'r') as file:
